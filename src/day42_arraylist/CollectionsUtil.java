...
public class CollectionsUtil {
    public static void main(String[] args) {
        ...
        letters.addAll(Arrays.asList('j', 'a', 'v', 'a', 'i', 's', 'f', 'u', 'n')); //can also declare by including this up above in the ()
        ...
        //find count of letter using Collections.frequency
        System.out.println("count of a = " + Collections.frequency(letters, 'a'));
