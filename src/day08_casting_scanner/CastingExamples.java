...
public class CastingExamples {
    public static void main(String[] args) {
        ...
        int num10 = 22;
        //byte num11 = num10; -->doesn't work b/c byte is < int; need to cast
        ...
        double num13 = 55.3;
        //float num14 = num13; -->doesn't work b/c double > float; need to cast
        ...
        System.out.println("num16 = " + num16); //will convert to W# so no decimal (ans=1234)
