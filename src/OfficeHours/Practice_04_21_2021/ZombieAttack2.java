...
public class ZombieAttack2 {
    public static void main(String[] args) {
        ...
        int days = 0;
        System.out.println("Day: " + days++ + " " + Arrays.toString(inhabitants)); //see array without any changes(original array)
        /*
        ...
        while(!Arrays.equals(inhabitants, new int[8])) { //checking if the new array is equal to inhabitants
            ...
            System.out.println("Day: " + days++ + " " + Arrays.toString(temp));
