...
public class SearchForElement {
    public static void main(String[] args) {
        ...
        System.out.println(findIndex(list, "two", 2)); //go to index 2 and then look for index of "two"
    ...
    public static int findIndex (ArrayList<String> words, String element){
        ...
        int index = -1; //0 is a valid index number so that's why we're using -1. return -1 if index does not exist(this is how java is set up)
