...
public class ArraysEquals {
    public static void main(String[] args) {
        ...
        System.out.println("nums1 == nums2 - " + Arrays.equals(nums1, nums2)); //true. checks values and length
        System.out.println(nums1 == nums2); //false. checks if pointing to same object in memory
        ...
        if(Arrays.equals(nums2, nums3)) {
            ...
            System.out.println("nums2 and nums3 do not match");
        }
